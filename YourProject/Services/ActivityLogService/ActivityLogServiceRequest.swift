//  ActivityLogServiceRequest.swift
//  YourProject
//
...
struct ActivityLogServiceRequest {
    
    struct FetchCreatorByFinancialRecord: Encodable {
        let hotelId: Int
    ...
    struct FetchCreatorByReservation: Encodable {
        let hotelId: Int
    ...
    struct FetchCreatorByAdditional: Encodable {
        let hotelId: Int
    ...
    struct FetchCreatorByAccount: Encodable {
        let hotelId: Int
        let accountId: Int
    ...
    struct FetchCreatorByAccountItem: Encodable {
        let hotelId: Int
